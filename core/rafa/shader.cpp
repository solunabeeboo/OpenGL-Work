...
void Shader::setVector(const std::string& name, float valuex, float valuey, float valuez) const
{
    glUniform3f(glGetUniformLocation(ID, name.c_str()), valuex, valuey, valuez);
}
void Shader::setVector(const std::string& name, float valuex, float valuey) const
{
